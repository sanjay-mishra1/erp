...
public class NewSignInActivity extends Activity implements View.OnClickListener {
    ...
    private void userLogin(String email) {
        ...
        loginLink=url+ "?txtUserName=" + uname + "&txtuserpass=" + pass + "&txt_captcha=" + "&txtsubmit="+captcha;
        ...
        if (!isStaff){
           // loadUrl(autologinNew);
            //isUrlLoaded=true;
            loadUrl(loginLink);
        }else
        if(isStop){
            isStop=false;
            loadUrl(NewSignInActivity.this.url);
...
//                loadUrl(autologinNew);
    ...
    void showError(StringBuilder message){
        ...
        AlertDialog.Builder alertDialog=
                new AlertDialog.Builder(NewSignInActivity.this);
    ...
    private class Browse extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (!url.contains("javascript")&!url.contains("login")& !url.contains("error")) {
                webView.stopLoading();
                finish();
                isStop=true;
                ...
                editor.apply();
                Intent intent=new Intent(NewSignInActivity.this,Home.class);
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if(isEnterCred)  {
                ...
                if (url.contains("login")){
                    ...
                    String autologinold =
                            "document.LoginForm.txtUserName.value='" + uname + "';\n" +
                                    "    document.LoginForm.txtuserpass.value='" + pass + "';\n" +
                                    "  try{\n" +
                    ...
                    String autologin="javascript:{document.getElementsByTagName(\"input\")[0].value='" +uname+"';"+
                            ...
                            "var frms=document.getElementsByName('txtsubmit');" +
                            "frms[0].click();}";
                   String urls=url+ "?txtUserName=" + uname + "&txtuserpass=" + pass + "&txt_captcha=" + "&txtsubmit="+captcha;
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            isStop=true;
            isPageFinished=false;
            Log.e("LoginError","Failed error "+error.toString());
