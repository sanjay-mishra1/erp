...
public class logIN extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("URL").contains("http://mit.thecollegeerp.com/academic/stlogin.php"))
...
//             findViewById(R.id.buttonLogin).setVisibility(View.VISIBLE);
     ...
     private void userLogin(String email) {
        ...
        if(Constants.type.equals("STAFF")){
            ...
            if (captcha.getText().toString().trim().isEmpty()){
        ...
        uname=email;
        pass=password;
        Log.e("UserName","Login u-"+uname+pass);
    ...
    private class Browse extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
           ...
           this. url=url;
            ...
            if (!url.equalsIgnoreCase(intent1.getStringExtra("URL"))) {
                webView.stopLoading();
                finish();
