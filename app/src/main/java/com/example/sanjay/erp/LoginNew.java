...
public class LoginNew extends Activity implements View.OnClickListener {
            ...
            loadUrl(LoginNew.this.url);
                ...
                webView.evaluateJavascript("javascript:(function(){ " +
                    ...
                    public void onReceiveValue(String value) {
                        Log.e("URL ","Inside userLogin() where isPageFinished=>"+ true);
    ...
    void showError(StringBuilder message){
        ...
        AlertDialog.Builder alertDialog=
                new AlertDialog.Builder(LoginNew.this);
...
*/
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            isPageFinished=false;
            if (!url.equalsIgnoreCase(intent1.getStringExtra("URL"))&& !url.contains("error")) {
                webView.stopLoading();
                finish();
                ...
                editor.apply();
                Intent intent=new Intent(LoginNew.this,Home.class);
        ...
        public void onPageFinished(WebView view, String url) {
          ...
          if(isEnterCred)  {
              ...
              if (url.equals(LoginNew.this.url)){
                  isEnterCred=false;
                  count = 1;
                  expand(progressBar, 300, dpToPx(124));
              ...
              webView.evaluateJavascript("javascript:(function(){ " +
                  ...
                  public void onReceiveValue(String value) {
                      ...
                      Log.e("URL ","Inside FinishedPage() where isPageFinished=>"+ isPageFinished+" and isCred is "+isEnterCred);
                      findViewById(R.id.webProgress).setVisibility(View.GONE);
                  }
